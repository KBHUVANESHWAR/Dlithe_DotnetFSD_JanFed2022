...
namespace string_function
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(firstname.Contains("DLithe")); //Check whether specified value exists or not in string

            Console.WriteLine(firstname.EndsWith(" camp")); //Check whether specified value is the last character of string
            ...
            Console.WriteLine(firstname.IndexOf("b")); //Returns the first index position of specified value
            ...
            Console.WriteLine(firstname.LastIndexOf("b")); //Returns the last index position of specified value
            ...
            Console.WriteLine(firstname.Replace('D', 'i')); // Replace the character

            string[] split = firstname.Split(new char[] { 'c' }); //Split the string based on specified value
            ...
            Console.WriteLine(firstname.StartsWith("T")); //Check wheter first character of string is same as specified value
